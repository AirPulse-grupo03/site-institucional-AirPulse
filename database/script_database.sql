...
CREATE TABLE funcionario (
    ...
    perfil TINYINT NOT NULL, -- ADM ou comum
...
/*TIREI:
 sentido_criticidade ENUM('ACIMA', 'ABAIXO') NOT NULL DEFAULT 'ACIMA',
     tempo_confirmacao_segundos INT UNSIGNED NOT NULL DEFAULT 60,
